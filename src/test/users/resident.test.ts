describe("users-residents. service", () => {
  describe("거주민 생성", () => {
    ...
    describe("successed case", () => {
      it("거주민 생성 성공시 204 뱉기");
    });
  });
  describe("거주민 리스트 조회", () => {
    describe("failed case", () => {
      it("인증된 유저가 아닌경우 401 에러던지기");
      it("관리자 권한이 아닌경우 403 에러던지기");
    });
    describe("successed case", () => {
        it("거주민 리스트 조회 성공시 204 뱉기");
    });
  });
  describe("거주민 조회", () => {
    describe("failed case", () => {
