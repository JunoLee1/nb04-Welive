...
export type TypeMap<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> = {
    ...
    meta: {
        modelProps: "user" | "resident" | "apartment";
...
export declare const UserScalarFieldEnum: {
    ...
    readonly role: "role";
    readonly hasNext: "hasNext";
    readonly joinStatus: "joinStatus";
    readonly isActive: "isActive";
    readonly avatar: "avatar";
};
export type UserScalarFieldEnum = (typeof UserScalarFieldEnum)[keyof typeof UserScalarFieldEnum];
export declare const ResidentScalarFieldEnum: {
    readonly id: "id";
...
export declare const ApartmentScalarFieldEnum: {
    ...
    readonly buildingNumberFrom: "buildingNumberFrom";
    readonly buildingNumberTo: "buildingNumberTo";
    readonly floorCountPerBuilding: "floorCountPerBuilding";
    readonly unitCountPerFloor: "unitCountPerFloor";
};
